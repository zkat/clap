...
/// Printing methods.
impl Colorizer {
    /// Color-aware printing. Attempts to draw colors whenever possible.
    #[cfg(feature = "color")]
    fn print_colored(&self) -> io::Result<()> {
    ...
    /// Chooses printing method depending on features.
    /// (Display impl vs Colorizer::print_colored)
    #[inline]
